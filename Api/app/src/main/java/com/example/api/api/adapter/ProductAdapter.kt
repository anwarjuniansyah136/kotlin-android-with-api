package com.example.api.api.adapter
...
import com.example.api.api.model.Product
import com.example.api.R

class ProductAdapter(private val onClick:(Product)->Unit) :ListAdapter<Product,ProductAdapter.ProductViewHolder>(ProductCallBack){
